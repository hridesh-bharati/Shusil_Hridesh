...
// export default NeiletCard;
import React from 'react'

export default function NieletCard() {
  return (
    <div>NieletCard Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, doloribus.</div>
  )
}
