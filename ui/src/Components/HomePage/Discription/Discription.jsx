                ...
                <div className="row">
                    <div className="col-md-12">
                        <ul>
                            ...
                            <li className="hoverTextOrange">This website ‘drishtee institute of information technology ’ is designed and developed by drishtee's student and content provided by the drishtee departments. The documents and information displayed in this website are for reference purposes only and do not purport to a legal document.</li>
