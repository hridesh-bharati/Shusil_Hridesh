...
const AdmissionForm = (() => {
  ...
  // const [AdmText, setAdmText] = useState('#0d6efd')
  ...
  return (
    <>
      ...
      <div className="row d-flex mx-0 px-0 align-items-center justify-content-center">
        <div className="col-12 fw-bolder text-center pt-5 shadow-sm  border border-bottom "
          ...
          <p className="fs-5 body-text-secondary">
            <Marquee behavior="alternate" style={{ color: "maroon" }}> ऑनलाइन पंजीकरण करने हेतु पंजीकरण फॉर्म </Marquee>
          </p>
          ...
          <div className="row  d-flex align-items-center justify-content-center mx-0 px-0">
            ...
            <div className="col-12 mx-0 px-1" style={{ color: 'maroon', borderTop: 'var(--my-border)' }}>
              ...
              <div className="container-fluid shadow-lg my-3 py-2 px-3">
                  ...
                  <div className="row py-2 chocolateBorder bg-primary-subtle">
                    <div className="col-md-6 bgps my-2">
                      ...
                      <div className="input-group mb-3">
                        ...
                        <input
                          className="form-control form-control-sm py-2 rounded-end"
                          id="formFileSm"
                          type="file"
                    ...
                    <div className="col-md-6 my-2">
                      ...
                      <div className="input-group mb-3"> <i className="bi bi-calendar-day-fill input-group-text "></i> <input
                        type="date" className="form-control" placeholder="जन्म तिथि दर्ज करें" value={dob} onChange={(event) => { setDob(event.target.value) }} required />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="my-4">
                  <h5 className="text-primary fw-bolder">(B) Personal Details</h5>
                  <div className="row py-4 chocolateBorder bg-primary-subtle">
                    ...
                    <div className="col-md-6">
                      <label htmlFor="validationCustom05" className="form-label">8: Adhar No <span
                        className="text-body-secondary">/ Adhar</span>
                        <font color="red"> * </font>
                      </label>
                      <div className="input-group mb-3">
                        <i className="bi bi-list-ol input-group-text "></i>
                        <input
                          type="text"
                ...
                <div className="my-4">
                  ...
                  <div className="row py-4 chocolateBorder bg-primary-subtle">
                    <div className="col-md-6">
                      <label htmlFor="validationCustom05" className="form-label">9: Course <span
                    ...
                    <div className="m-1">
                      ...
                      <div className="row py-3 chocolateBorder bg-primary-subtle ">
                        ...
                        <div className="input-group mb-3">
                          ...
                          <textarea type="text" rows={5} className="form-control" placeholder="पता दर्ज करें" value={address} onChange={(event) => { setAddress(event.target.value) }} required ></textarea>
                        </div>
                      </div>
                    </div>
                  </div>
